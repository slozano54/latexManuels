...
%
% ============================================================================================
% Modifier incIntroduction.tex en conséquence si on change introduction pour autre chose ici
\NewThema{I}{i}{introduction}{Introduction}{INTRODUCTION}{IColor}{IColor!50}

% Modifier incNumerique.tex en conséquence si on change nombres \&\\~calculs
% pour autre chose ici
...
% Ajout d'un logo
\newcommand*\NewLogoFont{\fontsize{9.5}{9.5}\sffamily\bfseries}  
