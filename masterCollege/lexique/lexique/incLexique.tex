% On factorise le titre du lexique
\newcommand{\titreLexique}{Titre Du Lexique}

\makeatletter\@openrightfalse                             % Pour éviter les pages blanches superflues introduite par la classe
\chapter*{\titreLexique\addcontentsline{toc}{chapter}{\titreLexique}} % On ajoute une entrée au sommaire au même rang que les chapitres manuellement
Dans cette section, on parle de \MotDefinition{lexique}{Dictionnaire succint.} et de glossaire.

Elle n'est pas destinée à être conservée en l'état.

Le lexique est construit de proche en proche en fonction de l'utilisation de la commande \textbf{MotDefinition}

Le mieux est peut-être de centraliser son utilisation dans le fichier \textbf{./lexique/lexique/incLexique.tex} plutôt que de la disséminer 
dans les différents fichiers des chapitres.
...
% ======= Lexique
% =======
% ======= RIEN À AJOUTER DANS CE FICHIER
% ======= LE LEXIQUE EST CONSTRUIT VIA L'UTILISATION DE LA COMMANDE MotDefinition
...
% % Par exemple, on utilise le code :
% \MotDefinition[mot]{mots}{Exemple mot lexique distinct du texte}

% ============================================================================================
% On peut centrailiser les entrées du lexique ici
