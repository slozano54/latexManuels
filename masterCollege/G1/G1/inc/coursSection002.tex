...
\begin{methode}[Titre de la méthode]
    Pour construire la \MotDefinition{médiatrice}{} d'un triangle, \ldots
    \exercice
    Texte de l’exercice
    \correction
...
\begin{methode*2*2}[Dernière méthode  \MethodeRefExercice{exoG1-exemple1} \MethodeRefExercice{exoG1-exemple2}]
    \exercice
    \label{methodeG1-exemple}
