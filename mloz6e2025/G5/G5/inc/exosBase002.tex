...
\begin{corrige}
  Compléter les phrases ci-dessous en utilisant la règle graduée ou le compas et la figure ci-contre.
  \begin{itemize}
     \item Le cercle ($\mathcal{C}_1$) de centre J passant par G passe également par les points {\red \fbox{A}} et  {\red \fbox{D}} 
     \item Le cercle ($\mathcal{C}_2$) de centre P et de rayon PH passe par les points  {\red \fbox{E}},  {\red \fbox{F}} et  {\red \fbox{G}}
     \item Les points  {\red \fbox{B}},  {\red \fbox{C}} et  {\red \fbox{D}} sont sur le cercle ($\mathcal{C}_3$) de centre F et de rayon EF.
     \item Les points A, F et I sont sur le même cercle ($\mathcal{C}_4$) de centre  {\red \fbox{H}}
     \item Le point situé à l'intersection des cercles ($\mathcal{C}_2$) et ($\mathcal{C}_4$) est le point  {\red \fbox{F}}
  \end{itemize}
  \Coupe
  \begin{center}
     \includegraphics[scale=0.8]{\currentpath/images/points}
