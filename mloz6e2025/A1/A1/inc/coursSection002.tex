...
\begin{methode*1}[Titre de la méthode*1]
    ...
    \Fraction[Disque,Rayon=13mm,Reponse,Couleur=0.85white]{1/3}
    \exercice
    Texte de l’exercice
    \correction
    Texte de la correction sur un minimum de trois lignes pour faire la
...
\begin{methode*2*2}[Dernière méthode  \MethodeRefExercice{exoA1-exemple1} \MethodeRefExercice{exoA1-exemple2}]
    \exercice
    \label{methodeA1-exemple}
