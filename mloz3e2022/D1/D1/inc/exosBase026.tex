\begin{exercice}
    ...
    \begin{enumerate}
        ...
        écoulé, en minutes, depuis son départ.\par\smallskip
        \hspace*{-12mm}
        \scalebox{0.75}{
        \Fonction[%
            Calcul=3*(x**2),%
            ...
            Bornea=0,Borneb=10,%
            % Problème de compilation avec la mise en gras
...
%            LabelY={{\bf Vitesse (en km/h)}},%
        ...
        \item Déterminer approximativement le temps mis par le train pour atteindre \Vitesse{120}.
