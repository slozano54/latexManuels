\begin{activite}
    ...
    \begin{center}
        \includegraphics[scale=0.45]{\currentpath/images/activiteRotationTux.png}
    \end{center}
    \begin{enumerate}
        ...
        \item Pour passer de Tux \Circled{$1$} à Tux \Circled{$2$}, on peut utiliser la rotation de centre $O$, d'angle \ang{130}, dans le sens inverse des aiguilles d'une montre.
