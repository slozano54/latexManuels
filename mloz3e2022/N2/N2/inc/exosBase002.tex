\begin{exercice*}
    ...
    \hrefMathalea[\emoji{star-struck} \emoji{link} - Division euclidienne]{https://coopmaths.fr/mathalea.html?ex=3A13-2,s=1,n=2,i=0&v=l}

    \hrefMathalea[\emoji{star-struck} \emoji{link} - Pas forcément division euclidienne]{https://coopmaths.fr/mathalea.html?ex=3A13-2,s=2,n=2,i=0&v=l}
\end{exercice*}
\begin{corrige}
