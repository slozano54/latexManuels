...
\MotDefinition{quotient}{Un quotient est le résultat d'une division.}
...
\MotDefinition{nombres inverses}{Deux nombres realtifs sont dits inverses quand leur produit vaut un.}
