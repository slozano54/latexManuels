...
\begin{remarque}
    ...
    \begin{myBox}{\infoComplementsNumeriques{singulier}}
        \infoComplementsNumeriques{singulier}

        \infoComplementsNumeriques{pluriel}

        \infoComplementsNumeriques{toto}
...
% \Methode{construction de l'image de M par rapport \`{a} l'axe (d)}{
% \begin{center}
% \begin{minipage}{4cm}
% \newrgbcolor{qqwuqq}{0 0.39 0}
% \psset{xunit=0.6cm,yunit=0.6cm,algebraic=true,dimen=middle,dotstyle=x,dotsize=3pt 0,linewidth=0.8pt,arrowsize=3pt 2,arrowinset=0.25}
% \begin{pspicture*}(0.7,-3.22)(5.58,1.36)
% \pspolygon[linecolor=qqwuqq,fillcolor=qqwuqq,fillstyle=solid,opacity=0.1](3.07,-0.85)(2.65,-0.93)(2.74,-1.34)(3.15,-1.26)
...
% \begin{minipage}{12cm}
% \begin{center}
% %\underline{Programme de construction de l'image de M par rapport \`{a} l'axe (d)} :\par
% \begin{enumerate}
...
% \end{center}
% \end{minipage}
% \infoComplementsNumeriques
% \lienCadre{http://lozano.maths.free.fr/iep_local/figures_html/scr_iep_113.html}{Construction à l'aide de la règle et de l'équerre}
% \lienCadre{http://lozano.maths.free.fr/iep_local/figures_html/scr_iep_111.html}{Construction à l'aide du compas}
% \end{center}
