...
\begin{corrige}
    ...
    \begin{enumerate}
        ...
        \begin{tikzpicture}[scale=0.45]
            ...
            \tkzDefPointBy[homothety=center A ratio 0.4](D1); \tkzGetPoint{D2};
            \tkzDefPointBy[homothety=center A ratio 0.4](E1); \tkzGetPoint{E2};            
            \tkzDefPointBy[homothety=center A ratio 0.8](E1); \tkzGetPoint{E3};
            \tkzDefBarycentricPoint(C2=1,D2=1,E2=1)
            \tkzGetPoint{G2}
            % Tracés
            \tkzDrawPoints[shape=cross out,size=3pt](A,B);
            ...
            \draw[fill=gray, fill opacity=0.2] (C1)--(D1)--(E1)--cycle;
            \draw[fill=gray, fill opacity=0.2] (C2)--(D2)--(E2)--cycle;
            \tkzMarkSegments[mark=oo,size=3pt](A,E2 E2,E3);
            \tkzDrawPoints[shape=circle,color=red](E1,E2,E3);
            \tkzDrawSegment[color=red, dashed](C1,A);
            \tkzDrawSegment[color=red, dashed](D1,A);
            \tkzDrawSegment[color=red, dashed](E1,A);            
            \tkzLabelPoint[above,shift={(0.2,0.5)}](G1){$\mathcal{F}_1$};
            \tkzLabelPoint[above,shift={(0,-0.3)}](G2){$\mathcal{F}_2$};    
            \tkzLabelPoint[below](E1){$E_1$};
            \tkzLabelPoint[below right](E2){$E_2$};
        \end{tikzpicture}
    \end{enumerate}
