...
\begin{exemple*1}
    \titreExemple{Homothétie de rapport positif}
    ...
    \begin{minipage}{0.25\linewidth}
        \includegraphics[scale=0.4]{\currentpath/images/coursHomothetieAvion1.png} 
    \end{minipage}
\end{exemple*1}

\begin{exemple*1}
    \titreExemple{Homothétie de rapport négatif}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[scale=0.5]{\currentpath/images/coursHomothetieAvion2.png} 
    \end{center}
\end{exemple*1}
...
\begin{methode*1}[Construction de l'image d'un triangle par homothétie]
    ...
    \begin{myBox}{\infoComplementsNumeriques{pluriel}}
        \begin{minipage}{\linewidth}
            \hrefConstruction{http://lozano.maths.free.fr/iep_local/figures_html/homothetie001.html}{Point par une homothétie de rapport positif}

            \medskip
            \hrefConstruction{http://lozano.maths.free.fr/iep_local/figures_html/homothetie002.html}{Point par une homothétie de rapport négatif}

            \medskip
            \hrefConstruction{http://lozano.maths.free.fr/iep_local/figures_html/homothetie002.html}{Carré par une homothétie}
