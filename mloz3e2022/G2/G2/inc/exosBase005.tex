\begin{exercice*}
    ...
    \end{itemize}
    \newcommand{\scaleGdeuxExCinq}{0.43}
    \begin{enumerate}
        \item \phantom{rrr}
        
        \begin{tikzpicture}[scale=\scaleGdeuxExCinq]            
