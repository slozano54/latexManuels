...
\begin{center}
    \begin{tikzpicture}[line width=0.8pt,scale=0.45]
        % Points
        \coordinate (O) at (-6,-5);
        \coordinate (A) at (0,-8);
        \coordinate (B) at (0,-5);
...
\begin{remarque}
    ...
    \begin{tikzpicture}[scale=0.7]
        ...
        \tkzDefPointBy[homothety=center O ratio 1.6](A); \tkzGetPoint{A'};
        \tkzDefPointBy[homothety=center O ratio 1.6](B); \tkzGetPoint{B'};
        \tkzDefPointBy[homothety=center O ratio 1.6](C); \tkzGetPoint{C'};
        % Tracés
