\begin{exercice*}
    ...
    \begin{center}
        ...
        \Cartographie[%
            ...
            Traces={%
                label.bot(TEX("\noexpand\tiny\textcolor{LightSteelBlue}{Méridien de Greenwich}"),Projgeo(rayon*(cosd(-45),0,sind(-45))));
                label.urt(TEX("\noexpand\tiny\textcolor{red}{Équateur}"),Projgeo(rayon*(cosd(0)*cosd(-30),cosd(0)*sind(-30),0)));
            }
        ]{5}{20}
    \end{center}    
\end{exercice*}
