...
\begin{corrige}
    ...
    \begin{enumerate}
        ...
        \medskip
        \begin{tabular}{|>{\columncolor{LightGray}}p{0.6\linewidth}|*{1}{@{}>{\vrule width0pt height\dimexpr.4cm-.2pt\relax depth\dimexpr.1cm-.2pt\relax\centering\arraybackslash}p{\dimexpr2cm-.4pt\relax}@{}|}}        
            \hline
    ...
    \begin{enumerate}
        ...
        \begin{tabular}{|>{\columncolor{LightGray}}p{0.6\linewidth}|*{1}{@{}>{\vrule width0pt height\dimexpr.4cm-.2pt\relax depth\dimexpr.1cm-.2pt\relax\centering\arraybackslash}p{\dimexpr2cm-.4pt\relax}@{}|}}        
            \hline            
            \cellcolor{red!30}Côté adjacent à l'angle $\widehat{EDF}$ & $[DE]$ \\\hline
        \end{tabular}        
        ...
        \begin{tabular}{|>{\columncolor{LightGray}}p{0.6\linewidth}|*{1}{@{}>{\vrule width0pt height\dimexpr.4cm-.2pt\relax depth\dimexpr.1cm-.2pt\relax\centering\arraybackslash}p{\dimexpr2cm-.4pt\relax}@{}|}}        
            \hline            
            \cellcolor{red!30}Côté adjacent à l'angle $\widehat{IGH}$ & $[GH]$ \\\hline
        \end{tabular}
    \end{enumerate}
\end{corrige}
