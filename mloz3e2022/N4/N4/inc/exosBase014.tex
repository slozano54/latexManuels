    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \begin{spacing}{1.2}
                ...
                $A=(2x+1)\times \left[\pointilles[0.7\linewidth]\right]$\\
                $A=\pointilles[0.9\linewidth]$
                \item[] $B=(x-1)^2+(x-1)(2x+3)$\\
                $B=(\pointilles[0.2\linewidth])\times (\pointilles[0.2\linewidth])+(x-1)(2x+3)$\\
                $B=\pointilles[0.9\linewidth]$
                $B=\pointilles[0.9\linewidth]$
            \end{spacing}
        \end{itemize}
