\begin{exercice*}[Quotients égaux]
    ...
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=4C20-2,s=2,n=4,i=1&v=l} % On peut personnaliser le texte entre crochets si on veut sinon supprimer les crochets
\end{exercice*}
\begin{corrige}
