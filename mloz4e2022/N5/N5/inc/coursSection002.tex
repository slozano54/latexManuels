...
\begin{definition}[L'exposant est un entier positif]
...
\begin{definition}[L'exposant est un entier négatif]
...
\begin{remarque}
    \titreRemarque{Pourquoi la formule magique des m zéros ?}
    \begin{itemize}
