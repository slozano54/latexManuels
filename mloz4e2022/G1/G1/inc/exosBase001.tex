\begin{exercice*}[Côtés homologues]
    ...
    \begin{enumerate}        
        ...
        Déterminer les côtés homologues aux côtés $[JZ]$, $[ZC]$ et $[CJ]$.\\
        \hspace*{-1cm}%
        \begin{tikzpicture}[baseline,scale = 0.25]        
            \tikzset{
                point/.style={
                thick,
                draw,
        ...
        \end{tikzpicture}
            ...
            Déterminer les côtés homologues aux côtés $[DE]$, $[EY]$ et $[YD]$.\\
        \hspace*{-1cm}%
        \begin{tikzpicture}[baseline,scale = 0.25]        
            \tikzset{
                point/.style={
        ...
        \end{tikzpicture}
            ...
            Déterminer les côtés homologues aux côtés $[AZ]$, $[ZG]$ et $[GA]$.\\
...
\begin{corrige}
    ...
    \begin{multicols}2
        \begin{enumerate}
            \item Les côtés homologues aux côtés $[JZ]$, $[ZC]$ et $[CJ]$ sont respectivement 
            $[IU]$, $[UN]$ et $[NI]$.
            \item Les côtés homologues aux côtés $[DE]$, $[EY]$ et $[YD]$ sont respectivement 
            $[MX]$, $[XT]$ et $[TM]$.
            \columnbreak
            \item Les côtés homologues aux côtés $[AZ]$, $[ZG]$ et $[GA]$ sont respectivement 
            $[AH]$, $[HV]$ et $[VA]$.
        \end{enumerate}
    \end{multicols}
\end{corrige}
