\begin{exercice*}
    ...
    \begin{Geometrie}[CoinHD={(17u,10u)}]
        ...
        trace appelation(A,M,3mm,btex {\LARGE $x$} etex);
        pair st,sr[];
        st=iso(F,C,B,M);
        label(btex {\LARGE\textbf{Salle de travail}} etex,st);
        sr1-iso(E,F)=u*(1.5,4);
        sr2-iso(E,F)=u*(1.5,3);
        sr3-iso(E,F)=u*(1.5,2);
        label(btex {\LARGE\textbf{Salle}} etex,sr1);
        label(btex {\LARGE\textbf{de}} etex,sr2);
        label(btex {\LARGE\textbf{Recherche}} etex,sr3);
        label.llft(btex {\LARGE $E$} etex,E);
        label.bot(btex  {\LARGE $D$} etex,D);
        label.bot(btex  {\LARGE $F$} etex,F);
        label.lrt(btex  {\LARGE $C$} etex,C);
        label.urt(btex  {\LARGE $B$} etex,B);
        label.top(btex  {\LARGE $M$} etex,M);
        label.ulft(btex {\LARGE $A$} etex,A);
    \end{Geometrie}
    }
