...
\begin{exemple*1}
    ...
    \begin{enumerate}
        ...
        \end{tabular}
        \smallskip
        \item On dénombre 6 cases RR sur 90.\\\smallskip        
        \psshadowbox{La probabilité de l'événement "obtenir rouge puis rouge" vaut donc $\dfrac{6}{90}=\dfrac{1}{15}$}
        \item On dénombre 21 cases RV sur 90.\\\smallskip        
        \psshadowbox{La probabilité de l'événement "obtenir rouge puis rouge" vaut donc $\dfrac{21}{90}=\dfrac{7}{30}$}
        \item \ldots
    \end{enumerate}
\end{exemple*1}
