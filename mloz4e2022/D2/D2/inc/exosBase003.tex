...
\begin{corrige}
    ...
    Calculer la moyenne du collège à ce contrôle. Arrondir au dixième.
    \par\smallskip\par
    \hspace*{-3mm}\Stat[Tableau,Donnee=Note,Largeur=5mm]{1/1,2/0,3/3,4/2,5/3,6/5,7/6}
    \par\smallskip\par
    \hspace*{-3mm}\Stat[Tableau,Donnee=Note,Largeur=5mm]{8/9,9/15,10/23,11/12,12/15,13/16,14/11}
    \par\smallskip\par
    \hspace*{-3mm}\Stat[Tableau,Donnee=Note,Largeur=5mm]{15/7,16/3,17/0,18/2,19/1,20/1}  
    \par\medskip
    \textcolor{red}{
