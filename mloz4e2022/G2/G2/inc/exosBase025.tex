\begin{exercice*}
    ...
    \begin{enumerate}
        ...
        $\dfrac{\text{Aire de $ABCD$}}{\text{Aire de $EFGH$}}=\dfrac{\makebox[1cm]{\dotfill}}{\makebox[1cm]{\dotfill}}=\dfrac{\makebox[1cm]{\dotfill}}{\makebox[1cm]{\dotfill}}=\left(\dfrac{\makebox[1cm]{\dotfill}}{\makebox[1cm]{\dotfill}}\right)^2$.
    \end{enumerate}
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=3G22-1,n=3,i=0&v=l}
\end{exercice*}
\begin{corrige}
