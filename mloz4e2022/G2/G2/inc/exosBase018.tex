\begin{exercice*}
    ...
    \begin{tikzpicture}[scale = 0.5]
            ...
            \coordinate[label=above:$\mathbf{Fig.~0}$] (F0) at (5.5,6.5);        
            % Fig1
            \coordinate[label=above:$\mathbf{Fig.~1}$] (F1) at (2.5,3);                    
            \coordinate (A) at (0,7);
            \coordinate (B) at (3,7);
            \coordinate (C) at (6,1);
            \coordinate (D) at (3,1);
            ...
            % Fig2
            \coordinate[label=above:$\mathbf{Fig.~2}$] (F2) at (10.5,8);        
            ...
            % Fig3
            \coordinate[label=above:$\mathbf{Fig.~3}$] (F3) at (16,9);        
    ...
    \hspace*{-10mm}
    \begin{tabular}{|c|>{\centering\arraybackslash}m{0.3\linewidth}|*{2}{>{\centering\arraybackslash}m{0.2\linewidth}|}}        
        \cline{2-4}
        \multicolumn{1}{c|}{}
