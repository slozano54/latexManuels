\section{Réciproque du théorème de Thalès}
    ...
    \subsection{Exemple de rédaction}
        ...
        \begin{methode*1}[Justifier que deux droites sont parallèles]
            ...
            \end{itemize}
            On constate que $\dfrac{AM}{AB} = \dfrac{AN}{AC}$, d'après la réciproque du théorème de Thalès, on peut conclure que \psshadowbox{les droites $(MN)$ et $(BC)$ sont parallèles}.
        \end{methode*1}
