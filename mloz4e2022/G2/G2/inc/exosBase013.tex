\begin{exercice*} 
    ...
    \begin{itemize}
        \item Les points $A$, $M$, $B$ sont alignés dans cet ordre.
        \item Les points $A$, $N$, $C$ sont alignés dans cet ordre.
    \end{itemize}
    \begin{tikzpicture}
    ...
    \begin{spacing}{1.5}            
        \begin{enumerate}
            ...
            \item Comparer les rapports $\dfrac{AM}{AB}$ et $\dfrac{AN}{AC}$.        
            \item Conclure sur le parallélisme de $(MN)$ et de $(BC)$.
        \end{enumerate}
    \end{spacing}
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=4G31,s=1,s2=2,s3=1,i=0&v=l}
\end{exercice*}
\begin{corrige}
