\section{Théorème de Thalès}
    ...
    \subsection{Configurations de Thalès}
        ...
        \begin{tikzpicture}[scale = 0.5]        
            ...
            \coordinate[label=above right:$C$] (N) at (9,5);
            \coordinate (N1) at (9.1,5.1);
            \coordinate[label=above left:$B$] (M) at (3,5);
            \coordinate (M1) at (2.9,5.1);
            \coordinate[label=above left:$M$] (B) at (5,9);            
            \coordinate (B1) at (5.1,9.1);
            \coordinate[label=above right:$N$] (C) at (8,9);
            \coordinate (C1) at (7.9,9.1);
            \tkzDrawSegment(A,M);
            \tkzDrawSegment(A,N);
            \tkzDrawSegment(M,N);
            \tkzDrawSegment(B,C);
            \draw[dashed, color=blue, ultra thick] (A)--(M1)--(N1)--(A);
            \draw[dashed, color=red, ultra thick] (A1)--(B1)--(C1)--(A1);
            \tkzDrawLine[dashed, color=black, ultra thick](M,N);
            \tkzDrawLine[dashed, color=black, ultra thick, add = 0.5 and 0.5](B,C);
        \end{tikzpicture}
        \end{minipage}
        \begin{minipage}{0.65\linewidth}
            Les deux triangles de la configuration ci-contre sont {\color{red}$AMN$} et {\color{blue}$ABC$}.
            ...
            \end{list}
            On peut appliquer le théorème de Thalès donc
            $\dfrac{\textcolor{red}{AM}}{\textcolor{blue}{AB}}=\dfrac{\textcolor{red}{AN}}{\textcolor{blue}{AC}}=\dfrac{\textcolor{red}{MN}}{\textcolor{blue}{BC}}$            
        \end{minipage}
        ...
        \begin{minipage}{0.65\linewidth}
            ...
            \end{list}
            On peut appliquer le théorème de Thalès donc 
            $\dfrac{\textcolor{blue}{AB}}{\textcolor{red}{AM}}=\dfrac{\textcolor{blue}{AC}}{\textcolor{red}{AN}}=\dfrac{\textcolor{blue}{BC}}{\textcolor{red}{MN}}$            
        \end{minipage}
        \begin{minipage}{0.32\linewidth}
        \begin{tikzpicture}[scale = 0.5]
            % \draw[help lines, color=black!30, dashed] (0,0) grid (12,14);        
        ...
        \begin{methode*1}[Calculer une longueur]
            ...
            \begin{minipage}{0.6\linewidth}
                \begin{tikzpicture}[scale=0.8]
                    ...
                    \coordinate[label=below:$N$] (N) at (2,1);
                    \coordinate (N1) at (1.9,0.95);
                    \coordinate[label=below:$S$] (S) at (10,1);
                    ...
                    \tkzLabelPoints[right,xshift=2mm](V);
                    \draw(O)--(N)--(S)--(O)--(V)--(M);
