...
\begin{propriete}[Comparaison lorsque les dénominateurs sont les mêmes]
    Si deux écritures fractionnaires ont le même dénominateur positif alors elles sont rangées dans l'ordre de leurs numérateurs.
\end{propriete}
...
\begin{propriete}[Comparaison lorsque les numérateurs sont les mêmes]
    Si deux écritures fractionnaires ont le même numérateur positif alors elles sont rangées dans l'ordre inverse de leurs dénominateurs.
\end{propriete}
