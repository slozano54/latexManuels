...
\begin{colonne*exercice}
  ...
  \end{exercice*}
  \begin{corrige}
  G1base serie 1 - On sait que $1=1$ avec l’exercice précédent donc $1+1=1+1$,
  c’est-à-dire $2=2$.
  \end{corrige}
  ...
  \end{exercice*}
  \begin{corrige}
  G1base serie2 - On sait que $1=1$ avec l’exercice précédent donc $1+1=1+1$,
  c’est-à-dire $2=2$.
  \end{corrige}
...
\begin{colonne*exercice}
  ...
  \end{exercice*}
  \begin{corrige}
  G1appr série2 - On sait que $1=1$ avec l’exercice précédent donc $1+1=1+1$,
  c’est-à-dire $2=2$.
  \end{corrige}
\end{colonne*exercice}
...
\recreation
  \begin{enigme}[Titre optionnel]
    ...
    \end{enigme}
    % \begin{corrige}
    %   Correction enigme Scratch partie TP
    % \end{corrige}

% ============================================================================================
% ======= Annexes
% ======= Interdictions a priori
% ==========> L'environnement "corrige" --> Il semble que non à fixer  la compilation doit planter
...
\recreation
  \begin{enigme}[Titre optionnel]
    ...
    \end{enigme}
    % \begin{corrige}
    %   AnnexeI - Corrige enigme scratch 
    % \end{corrige}
