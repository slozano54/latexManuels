...
\chapter{themaF1}
\cours  
\begin{methode}[Titre de la méthode chapF1]
  Texte introductif
  \exercice
  Texte de l’exercice
  \correction
...
\begin{methode}[Titre de la méthode AnnexeI]
  Texte introductif
  \exercice
  Texte de l’exercice
  \correction
...
\begin{methode*1}[Titre de la méthode*1 AnnexeI]
  Texte introductif
  \exercice
  Texte de l’exercice
  \correction
...
\begin{methode*2}[Titre de la méthode*2 AnnexeI]
  Texte introductif
  \exercice
  Texte de l’exercice
  \correction
...
\begin{methode*2*2}[Dernière méthode AnnexeI\MethodeRefExercice{exo-exemple1} \MethodeRefExercice{exo-exemple2}]
  \exercice
