...
\Formule[Aire,Surface=triangle,Ancre={([xshift=3cm,yshift=-3cm]current page.west)}]
\Formule[Aire,Surface=losange,Ancre={([xshift=5cm,yshift=7cm]current page.south west)},Angle=-20,Largeur=6cm]
% \begin{center}
