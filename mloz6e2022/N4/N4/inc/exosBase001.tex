\begin{exercice*}        
    ...
    \end{enumerate}
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=6C13-1,s=1-2-3-4-5-6,n=6&v=l} % On peut personnaliser le texte entre crochets si on veut sinon supprimer les crochets
\end{exercice*}
\begin{corrige}
