...
\begin{changemargin}{-10mm}{-10mm}
   ...
   %    \begin{center} 
   %       \includegraphics[width=4cm]{\currentpath/images/crop}
   %    \end{center}
   %    \bigskip
   %    \begin{cadre}[B2][F4]
   %       \begin{center}        
   %       \hrefVideo{https://www.youtube-nocookie.com/embed/AqjSJuhdZ_s?playlist=AqjSJuhdZ_s&autoplay=1&iv_load_policy=3&loop=1&modestbranding=1&start=}{\bf making of de la réalisation}, {\it youtube}.

   %       \vspace*{2mm}
   %       \hrefVideo{https://www.francetvinfo.fr/replay-jt/france-2/20-heures/video-en-alsace-les-mysterieux-cercles-dans-le-champ-etaient-un-cours-de-maths_3505711.html}{\bf Les mystérieux cercles dans le champ étaient un cours de maths}
