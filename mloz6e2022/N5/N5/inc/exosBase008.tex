\begin{exercice*}        
    ...
    \begin{enumerate}
       ...
       \vspace*{10mm}
        ...
        \vspace*{10mm}
    \end{enumerate}}
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=6N21,s=1,n=5,i=0&v=l}

    \medskip
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=6N21,s=2,n=5,i=0&v=l}
    
    \medskip
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=6N21,s=3,n=5,i=0&v=l}
\end{exercice*}
\begin{corrige}
