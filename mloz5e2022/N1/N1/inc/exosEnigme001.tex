...
\begin{corrige}
    ...
    \begin{tabular}{|*{7}{>{\centering\arraybackslash}p{0.6cm}|}}
        \hline
        2 & $+$ & 3 & $\times$ & \textcolor{red}{5} & $=$ & 17 \\
        \hline
        $\times$ & \cellcolor{gray} & $+$ & \cellcolor{gray} & $+$ & \cellcolor{gray} & $\times$ \\
        \hline
        \textcolor{red}{39} & $\times$ & \textcolor{red}{9} & $-$ & 201 & $=$ & 150 \\
        \hline
        $=$ & \cellcolor{gray} & $=$ & \cellcolor{gray} & $=$ & \cellcolor{gray} & $=$ \\
        \hline
        \textcolor{red}{78} & $+$ & 12 & $\times$ & \textcolor{red}{206} & $=$ & \textcolor{red}{2\,550} \\
        \hline
    \end{tabular}}
    }
    ...
    {\renewcommand{\arraystretch}{2}
        \begin{tabular}{|*{7}{>{\centering\arraybackslash}p{0.6cm}|}}
            ...
            $\times$ & & $+$ & & $+$ && $-$ \\
            \cline{1-1} \cline{3-3} \cline{5-5} \cline{7-7}
            \textcolor{red}{3} & & 7 & & 9 & & \textcolor{red}{4} \\
            \cline{1-3} \cline{5-7}
            $\div$ & \textcolor{red}{1} & $+$ & & $\times$ & 8 & $\div$ \\
            \cline{1-3} \cline{5-7}
        \end{tabular}}
    }
    ...
    \begin{pspicture}(7,10)
        ...
        \psframe(2,4)(5,5)
        \psframe(3,3)(4,7)
        \rput(0.5,0.5){\textcolor{red}{5}}
        \rput(1,0.5){\psframebox*[fillcolor=white]{$-$}}
        \rput(1.5,0.5){2}
        \rput(2,0.5){\psframebox*[fillcolor=white]{$=$}}
        \rput(2.5,0.5){\textcolor{red}{3}}
        \rput(4.5,0.5){\textcolor{red}{4}}
        \rput(5.05,0.5){\psframebox*[fillcolor=white]{$+$}}
        \rput(5.5,0.5){\textcolor{red}{1}}
        \rput(6,0.5){\psframebox*[fillcolor=white]{$=$}}
        \rput(6.5,0.5){\textcolor{red}{5}}
        \rput(0.5,1.5){3}
        \rput(2.5,1.5){\textcolor{red}{6}}
        \rput(4.5,1.5){1}
        \rput(6.5,1.5){4}
        \rput(0.5,2){\psframebox*[fillcolor=white]{$=$}}
        \rput(2.5,2){\psframebox*[fillcolor=white]{$=$}}
        ...
        \rput(6.5,2){\psframebox*[fillcolor=white]{$=$}}
        \rput(0.5,2.5){7}
        \rput(2.5,2.5){\textcolor{red}{7}}
        \rput(3,2.5){\psframebox*[fillcolor=white]{$-$}}
        \rput(3.5,2.5){5}
        \rput(4,2.5){\psframebox*[fillcolor=white]{$=$}}
        \rput(4.5,2.5){\textcolor{red}{2}}
        \rput(6.5,2.5){\textcolor{red}{9}}
        \rput(0.5,3){\psframebox*[fillcolor=white]{$\times$}}
        \rput(2.5,3){\psframebox*[fillcolor=white]{$\times$}}
        \rput(4.5,3){\psframebox*[fillcolor=white]{$\times$}}
        \rput(6.5,3){\psframebox*[fillcolor=white]{$\times$}}
        \rput(0.5,3.5){\textcolor{red}{5}}
        \rput(1.05,3.5){\psframebox*[fillcolor=white]{$+$}}
        \rput(1.5,3.5){\textcolor{red}{4}}
        \rput(2,3.5){\psframebox*[fillcolor=white]{$=$}}
        \rput(2.5,3.5){\textcolor{red}{9}}
        \rput(4.5,3.5){7}
        \rput(5,3.5){\psframebox*[fillcolor=white]{$-$}}
        \rput(5.5,3.5){\textcolor{red}{2}}
        \rput(6,3.5){\psframebox*[fillcolor=white]{$=$}}
        \rput(6.5,3.5){\textcolor{red}{5}}
        \rput(1.5,4){\psframebox*[fillcolor=white]{$=$}}
        \rput(5.5,4){\psframebox*[fillcolor=white]{$=$}}
        \rput(1.5,4.5){2}
        \rput(5.5,4.5){2}
