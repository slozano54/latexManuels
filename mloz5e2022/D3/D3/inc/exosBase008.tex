\begin{exercice*} %8
   ...
   \begin{center}
      \includegraphics[width=8cm]{\currentpath/images/cadastre}
   \end{center}
\end{exercice*}

\begin{corrige}
   Une échelle au 1:500 signifie que \Lg[cm]{1} sur le dessin représente \Lg[cm]{500} dans la réalité, ou encore \Lg[m]{5}. \\
