\begin{exercice*}[diagramme semi-circulaire]
    ...
    \hrefMathalea{https://coopmaths.fr/mathalea.html?ex=5S12,s=3,s2=1,s3=2,s4=true&v=l} % On peut personnaliser le texte entre crochets si on veut sinon supprimer les crochets
\end{exercice*}
\begin{corrige}
