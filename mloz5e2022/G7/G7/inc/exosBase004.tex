\begin{exercice*} %4
   ...
   \begin{enumerate}
      \item $AB =\Lg[cm]{5} \; ; AD =\Lg[cm]{3,5}$ et $BD =\Lg[cm]{7}$.
      \item $EF =\Lg[cm]{2} \; ; EH =\Lg[cm]{4,5}$ et $EG = \Lg[cm]{3,5}$.
   \end{enumerate}
\end{exercice*}
\begin{corrige}
\ \\ [-5mm]
   \begin{enumerate}
      ...
      \pstGeonode[PointSymbol=none,CurveType=polygon,PosAngle={-135,-45,45,135}]{A}(5,0){B}(3.8,3.3){C}(-1.2,3.3){D}
            \pstLineAB{D}{B}
            \pstLabelAB{D}{B}{\color{red} \Lg[cm]{7}}
            \pstLabelAB[offset=-3mm]{D}{A}{\color{red} \Lg[cm]{3,5}}
            \pstLabelAB[offset=-3mm]{A}{B}{\color{red} \Lg[cm]{5}}
      ...
      \pstGeonode[PointSymbol=none,CurveType=polygon,PosAngle={-135,-45,45,135}]{E}(4.5,0){H}(3.5;25.2){G}(2;131.8){F}
            \pstLineAB{E}{G}
            \pstLabelAB{E}{G}{\color{red} \Lg[cm]{3,5}}
            \pstLabelAB[offset=-4mm]{E}{H}{\color{red} \Lg[cm]{4,5}}
            \pstLabelAB[offset=-4mm]{F}{E}{\color{red} \Lg[cm]{2}}
