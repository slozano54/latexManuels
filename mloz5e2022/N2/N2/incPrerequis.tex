...
\begin{debat}[Les unités de mesure de température]
   ...
   \begin{itemize}
      \item l'échelle Fahrenheit, créée en 1720 par le scientifique allemand {\bf Gabriel Fahrenheit} et allant de \udeg{32}F à \udeg{212}F ;
   ...
   \begin{cadre}[B2][J4]
      \begin{center}
         \hrefVideo{https://www.yout-ube.com/watch?v=nzirDkQN99M&rel=0}{\bf Celsius et Fahrenheit}, chaîne YouTube {\it Ma deuxième école}, série {\it Culture G}.
      \end{center}
   \end{cadre}
   \end{changemargin}
\end{debat}