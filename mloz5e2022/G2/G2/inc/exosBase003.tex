\begin{exercice*}
   On se place dans un repère orthogonal d'origine $O$ et d'unité \ucm{1}. Utiliser la feuille à petits carreaux fournie.
   \begin{enumerate}
...
\begin{corrige}   
   ...
   \begin{pspicture}(-3.5,-2)(4,2.2)
      ...
      \pstLineAB[linecolor=red]{B}{C}
      \pstLineAB[linecolor=red]{C}{D}
      \pstLineAB[linecolor=red]{D}{A}
