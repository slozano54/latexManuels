...
\begin{corrige}
   ...
   \begin{enumerate}
      ...
      Ses coordonnées sont donc {\red (160\,;\,120)}.
      \item \\
      \begin{enumerate}
         \item La touche $\to$ ajoute 80 à l'abscisse $x$ ; la touche $\gets$ ajoute $-40$ à l'abscisse $x$ ; donc, la succession $\to \, \gets$ ajoute $80+(-40) =40$ à l'abscisse $x$. \\
            Le chat a donc \og avancé \fg{} de 40 unités vers la droite,  {\red il ne revient pas à sa position de départ}. 
            % \vspace*{11.5cm}
         ...
         Les coordonnées du chat après ces cinq déplacements sont {\red $(0\,;\,-40)$}.
         \item Seul le {\red déplacement 2} permet au chat d'attraper la balle.
      \end{enumerate}
      \setcounter{enumi}{2}
      \item Quand le chat atteint la balle, {\red il dit \og Je t'ai attrapée \fg{} pendant 2 sec.} puis retourne au départ. 
   \end{enumerate}
\end{corrige}
