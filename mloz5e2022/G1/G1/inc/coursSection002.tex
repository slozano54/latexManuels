...
% \proprNum{Angles opposés par le sommet}{deux angles sont opposés par le sommet}{ils ont la même mesure.}

% \CadreLampe{Preuve}{
% \begin{minipage}{5cm}
% \begin{center}
% \includegraphics[scale=1]{anglesparallelisme.6} 
% \end{center}
% \end{minipage}
% \begin{minipage}{11cm}
...
% \proprNum{Angles alternes-internes}{deux droites \textbf{parallèles} sont coupées par une troisième}{deux angles en position d'angles alternes-internes sont égaux.}
...
% \begin{minipage}{7cm}
% \begin{center}
% \includegraphics[scale=0.8]{anglesparallelisme.8} 
% \end{center}
% \end{minipage}
% }

% \proprNum{Angles correspondants}{deux droites \textbf{parallèles} sont coupées par une troisième}{deux angles en position d'angles correspondants sont égaux.}
