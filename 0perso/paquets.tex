...
% Extensions tikz supplémentaires pour marquage des angles, des flèches
...
\usepackage{pst-eucl}
% Pour les figures fractales
\usepackage{pst-fractal}
% Pour des objets rigolos pstricks
\usepackage{pst-fun}

% Pour les lettres qualigrafiées géométrie
...
% Pour séparer une cellule de tableau selon sa diagonale avec deux textes
\usepackage{slashbox}

% Pour les circuits electriques
\usepackage[european, straightvoltages, RPvoltages]{circuitikz}
% Pour les hdashline dans les tableaux Problème ici avec les lignes verticales des environnements de tableau
% \usepackage{arydshln}