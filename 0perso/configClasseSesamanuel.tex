...
\renewcommand*\StringManuel{Des ressources num\'eriques pour pr\'eparer
  le chapitre sur
  \href{https://aleatex.mathslozano.fr}{\textcolor{Kawasaki}{\LogoURLManuelFont https://aleatex.mathslozano.fr}}}
...
% Logo AleaTeX
\newcommand*\StringALEATEX{Alea\TeX}
\colorlet{aleatexLineColor}{H2}
\definecolor{Kawasaki}{HTML}{00B51A}
\colorlet{aleatexBkgColor}{Kawasaki}
\colorlet{aleatexTextColor}{Blanc}
\newcommand*\aleatexLogo{%
  \psframebox[framesep=1pt,linewidth=\LogoLineWidth,
              linecolor=aleatexLineColor, fillstyle=solid,
              fillcolor=aleatexBkgColor, framearc=0.6]{%
    \NewLogoFont
    \textcolor{aleatexTextColor}{\StringALEATEX}%
  }
}
...
% Un environnement pour AleaTeX
\DeclareActivityLike{aleatex}{BESOIN DE RÉVISER}{J3}{J1}{H1}
