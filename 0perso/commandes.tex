...
% #1 --> emojis par dafaut
% Par défaut #1 est le smiley monocle + le smiley link mais cela peut être modifié
% #2 --> url
% #3 --> texte
\newcommand{\hrefConstruction}[3][\emoji{face-with-monocle} \emoji{link}]{
    \href{#2}{#1 #3} 
}
...
\newcommand{\infoComplementsNumeriques}[1]{
    \ifthenelse{\equal{#1}{singulier}}{\textbf{Complément numérique}}{%
        \ifthenelse{\equal{#1}{pluriel}}{\textbf{Compléments numériques}}{%
            \textbf{#1}
        }
    }
}
